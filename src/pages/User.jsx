import {FaCodepen, FaUsers, FaStore, FaUserFriends, FaSearch } from 'react-icons/fa'
  ...
  useEffect(()=> {
    ...
    dispatch({type: 'SET_LOADING'})
      const getUserData = async() => {
          ...
          // const userRepoData = await getUserAndRepos(params.login)
            ...
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions">
                <a href={html_url} target='_blank'
                  rel='noreferer' className='btn btn-outline'
                >
